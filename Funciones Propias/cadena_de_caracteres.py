...
def validar_int_float(variable:str)->bool:
    """
    Summary:
        Valida que la variable sea del tipo INT o FLOAT o que la cadena de caracteres contenga solo numeros.
    Args:
        variable(str): Cadena de caracteres.
    Returns:
        bool: True si la cadena de caracteres contiene solo numeros. False de lo contrario.
    """ 
