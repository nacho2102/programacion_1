...
class Sprites:
    def __init__(self):
        self.sprite_parameters = {
            'sprite_barrel': {
                'sprite': pygame.image.load('C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/barrel/base/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 1.8,
                'scale': (0.4, 0.4),
                'side': 30,
                'animation': deque(
                    [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/barrel/anim/{i}.png').convert_alpha() for i in range(12)]),
                'death_animation': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/barrel/death/{i}.png')
            ...
            'sprite_pin': {
                'sprite': pygame.image.load('C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/pin/base/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 0.6,
                'scale': (0.6, 0.6),
                'side': 30,
                'animation': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/pin/anim/{i}.png').convert_alpha() for i in range(8)]),
                'death_animation': [],
                'is_dead': 'immortal',
                'dead_shift': None,
                'animation_dist': 800,
            ...
            'sprite_flame': {
                'sprite': pygame.image.load('C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/flame/base/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 0.7,
                'scale': (0.6, 0.6),
                'side': 30,
                'animation': deque(
                    [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/flame/anim/{i}.png').convert_alpha() for i in range(16)]),
                'death_animation': [],
                'is_dead': 'immortal',
                'dead_shift': 1.8,
                'animation_dist': 1800,
            ...
            'npc_devil0': {
                'sprite': [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/devil0/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.0,
                'scale': (1.1, 1.1),
                'side': 50,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/devil0/death/{i}.png')
                ...
                'flag': 'npc',
                'obj_action': deque(
                    [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/devil0/anim/{i}.png').convert_alpha() for i in range(9)]),
            },
            'npc_devil1': {
                'sprite': [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/devil1/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0,
                'scale': (0.9, 1.0),
                'side': 30,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/devil1/death/{i}.png')
                ...
                'blocked': True,  # <-------------------
                'flag': 'npc',
                'obj_action': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/devil1/action/{i}.png')
                                    .convert_alpha() for i in range(6)])
            },
            'npc_soldier0': {
                'sprite': [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/soldier0/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.8,
                'scale': (0.4, 0.6),
                'side': 30,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/soldier0/death/{i}.png')
                ...
                'blocked': True,
                'flag': 'npc',
                'obj_action': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/soldier0/action/{i}.png')
                                            .convert_alpha() for i in range(4)])
            },
            'npc_soldier1': {
                'sprite': [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/soldier1/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.8,
                'scale': (0.4, 0.6),
                'side': 30,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/soldier1/death/{i}.png')
                                            .convert_alpha() for i in range(11)]),
                'is_dead': None,
                'dead_shift': 1.7,
                'animation_dist': None,
                ...
                'blocked': True,  # <-------------------
                'flag': 'npc',
                'obj_action': deque([pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/npc/soldier1/action/{i}.png')
                                    .convert_alpha() for i in range(4)])
            },
            'sprite_door_v': {
                'sprite': [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/doors/door_v/{i}.png').convert_alpha() for i in range(16)],
                'viewing_angles': True,
                'shift': 0.1,
                'scale': (2.6, 1.2),
                'side': 100,
            ...
            'sprite_door_h': {
                'sprite': [pygame.image.load(f'C:/Users/nacho/OneDrive/Escritorio/Facultad/1er Cuatrimestre/Programacion 1/Python-DOOM-master/Python-DOOM-master/sprites/doors/door_h/{i}.png').convert_alpha() for i in range(16)],
                'viewing_angles': True,
                'shift': 0.1,
                'scale': (2.6, 1.2),
                'side': 100,
