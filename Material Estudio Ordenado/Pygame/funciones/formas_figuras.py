...
while running: # -> Cuerpo del bucle
    ...
    pygame.draw.line(screen, (255, 0, 0), (50, 50), (100, 50), 5) # Se dibuja una línea roja por la mitad de la pantalla recibienodo por parámetro(pantalla, color, coordenadas y tamaños)
